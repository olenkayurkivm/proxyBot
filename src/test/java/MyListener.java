...
public class MyListener implements  ITestListener {
    ...
    private static final String SCREENSHOT_FOLDER = "C:/Users/OYurkiv/Documents/RateBackUps/trustscreens";
    ...
    public void takeScreenshot(ITestResult result) {
        ...
        try {
            ...
            File screenFile = ((TakesScreenshot) TrustAbstractPage.getDriver()).getScreenshotAs(OutputType.FILE);
