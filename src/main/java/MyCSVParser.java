...
public class MyCSVParser {
    ...
    public static final String ORDERS_CSV = "src/test/resources/trustorders.csv";
    public static final String COMMENTS_CSV = "src/test/resources/trustcomments.csv";
    public static final String PROXY_CSV = "src/test/resources/trustproxy.csv";
    public static final String USED_PROXY_CSV = "src/test/resources/trustusedproxy.csv";
